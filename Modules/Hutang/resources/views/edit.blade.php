            ...
            <div class="panel panel-inverse" data-sortable-id="form-plugins-3">
                ...
                <div class="panel-body p-0">
                    <form class="form-horizontal form-bordered" action="{{ route('hutang.store') }}" method="post"
                        ...
                        @csrf
                        <h4 class="m-4">Anda melakukan pembayaran kepada <span
                                style="font-weight: bold">{{ $data->name }}</span>
                            sebesar</h4>
                        ...
                        <div class="form-group row">
                            <label class="form-label col-form-label col-lg-4">Sumber Dana</label>
                            <div class="col-lg-8">
