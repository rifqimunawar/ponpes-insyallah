...
@section('content')
    ...
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Form Kegiatan <small>{{ $userLogin->name }}</small></h1>
    <!-- END page-header -->
    <!-- BEGIN row -->
    <div class="row">
        <!-- BEGIN col-10 -->
        <div class="col-xl-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-heading">
                    <h4 class="panel-title">DataTable - Kegiatan</h4>
                ...
                <!-- END panel-heading -->
                <!-- BEGIN panel-body -->
                <a href="{{ route('kegiatan.create') }}" class="btn btn-primary btn-sm">Tambah
                            ...
                            @foreach ($data as $item)
                                <tr class="even gradeC">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('kegiatan.destroy', $item->id) }}" class="btn btn-danger"
