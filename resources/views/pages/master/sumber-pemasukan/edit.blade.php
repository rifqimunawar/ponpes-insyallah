        ...
        <div class="col-xl-8">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-plugins-3">
                ...
                <div class="panel-body p-0">
                    <form class="form-horizontal form-bordered" action="{{ route('sumber-pemasukan.update', $data->id) }}"
                        ...
                        <div class="text-center mt-4 mb-4">
                            <a href="{{ route('sumber-pemasukan.index') }}" class="btn btn-warning">Kembali</a>
