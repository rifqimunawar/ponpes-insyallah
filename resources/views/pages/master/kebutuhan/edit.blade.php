...
@section('content')
    ...
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Form Kebutuhan <small>header small text goes here...</small></h1>
    <!-- END page-header -->
    <!-- BEGIN row -->
    <div class="row">
        <!-- BEGIN col-6 -->
        <div class="col-xl-8">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-plugins-3">
                ...
                <div class="panel-body p-0">
                    <form class="form-horizontal form-bordered" action="{{ route('kebutuhan.update', $data->id) }}"
                        method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label class="form-label col-form-label col-lg-4">Nama</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control uang" name="name" value="{{ $data->name }}"
                                    required>
                            </div>
                        </div>
                        <div class="text-center mt-4 mb-4">
                            <a href="{{ route('kebutuhan.index') }}" class="btn btn-warning">Kembali</a>
