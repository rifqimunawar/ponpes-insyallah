...
@section('content')
    ...
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Form Edit Pemasukan <small>header small text goes here...</small></h1>
    <!-- END page-header -->
    <!-- BEGIN row -->
    <div class="row">
        <!-- BEGIN col-6 -->
        <div class="col-xl-8">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-plugins-3">
                ...
                <div class="panel-body p-0">
                    <form class="form-horizontal form-bordered" action="{{ route('pemasukan.update', $data->id) }}"
                            ...
                            <div class="col-lg-8">
                                <select class="form-select" name="sumber_pemasukan_id" aria-label="Default select example"
                                    ...
                                    @foreach ($sumber as $item)
                                        <option value="{{ $item->id }}"
                                            {{ isset($data) && $data->sumber_pemasukan_id == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
